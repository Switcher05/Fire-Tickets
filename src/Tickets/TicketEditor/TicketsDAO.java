...
public interface TicketsDAO {
     ...
     * @param serial The ID of the user to be returned.
     ...
     * @throws DAOException If something fails at database level.
     */
    //TODO disabled until more data fields are added.
     ...
     * @throws DAOException If something fails at database level.
     */
    public void update(Tickets tickets) throws IllegalArgumentException, DAOException;
